...
export default function Projects({ projects, pageLang }) {
  // const  =
  //   projects;

  // const title = pageLang === "en" ? title_en : title_jp;
  // const description = pageLang === "en" ? description_en : description_jp;
        ...
        ({
          ...
          >
            <div className="flex-1 md:py-4 px-2">
              ...
              <p className="max-w-[64ch] md:text-xl">
                {pageLang === "en" ? description_en : description_jp}
              </p>
              {link && (
                <Link
                  to={link}
